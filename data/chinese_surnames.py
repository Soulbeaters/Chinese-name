...
SINGLE_SURNAMES = {
    '艾', '安', '敖', '巴', '白', '柏', '班', '包', '鲍', '暴',
    '贝', '贲', '边', '卞', '毕', '别', '宾', '薄', '卜', '步', '才',
    '蔡', '苍', '曹', '查', '柴', '昌', '常', '晁', '超', '车', '陈',
    '成', '程', '池', '迟', '充', '仇', '丑', '储', '楚', '褚',
    '崔', '戴', '刀', '邓', '狄', '刁', '丁', '定', '东', '董',
    '窦', '杜', '段', '端', '敦', '多', '鄂', '樊', '范', '方',
    '房', '费', '封', '酆', '冯', '凤', '符', '伏', '扶', '福', '傅',
    '富', '盖', '甘', '干', '高', '葛', '耿', '弓', '宫', '巩',
    '贡', '苟', '古', '谷', '顾', '关', '管', '郭', '桂', '国',
    '韩', '杭', '郝', '昊', '豪', '何', '贺', '赫', '衡', '洪', '侯', '后',
    '胡', '花', '华', '怀', '桓', '黄', '惠', '霍', '吉', '姬',
    '计', '纪', '贾', '简', '江', '姜', '蒋', '焦', '揭', '杰', '金',
    '晋', '景', '井', '荆', '居', '鞠', '康', '柯', '孔', '寇', '坤',
    '匡', '邝', '况', '赖', '蓝', '郎', '劳', '乐', '雷', '冷',
    '黎', '李', '力', '历', '连', '廉', '梁', '廖', '林', '凌',
    '刘', '柳', '龙', '娄', '卢', '鲁', '陆', '路', '栾', '罗',
    '骆', '吕', '律', '麻', '马', '麦', '满', '茅', '毛', '梅',
    '孟', '米', '苗', '闵', '明', '缪', '莫', '墨', '牟', '母',
    '穆', '南', '倪', '聂', '宁', '牛', '农', '欧', '区', '潘', '庞',
    '裴', '彭', '皮', '蒲', '浦', '戚', '祁', '齐', '钱', '强',
    '乔', '秦', '邱', '丘', '曲', '屈', '全', '冉', '饶', '任',
    '荣', '阮', '芮', '桑', '沙', '山', '商', '邵', '佘', '申',
    '沈', '盛', '施', '时', '石', '史', '舒', '帅', '隋', '双', '水',
    '司', '松', '宋', '苏', '孙', '索', '谈', '谭', '汤', '唐',
    '陶', '滕', '田', '童', '涂', '万', '汪', '王', '危', '韦',
    '魏', '温', '文', '闻', '翁', '巫', '邬', '吴', '伍', '武',
    '席', '习', '夏', '鲜', '冼', '相', '向', '项', '肖', '谢',
    '辛', '邢', '幸', '修', '熊', '徐', '许', '宣', '薛', '荀', '闫',
    '严', '颜', '晏', '阎', '杨', '羊', '养', '姚', '叶', '易',
    '殷', '尹', '应', '英', '游', '于', '余', '俞', '虞', '鱼',
    '禹', '袁', '岳', '云', '臧', '曾', '翟', '詹', '占', '张',
    '章', '赵', '郑', '甄', '钟', '仲', '周', '朱', '竺', '祝', '庄',
    '卓', '宗', '邹', '祖', '左', '丛', '从',
}
